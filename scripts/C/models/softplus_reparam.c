...
#include <math.h>
#include "softplus_reparam.h"

/*------------------------  MODEL PARAMETERS  -------------------------*/

const struct Params default_params = {0.5, 0.1, 0.01, 20., 0.25, 2.*M_PI/360., .9, 0.00025, 1., 1000.};
...
double foi(double H, double I, Params *params){
	return (params->foi_slope*params->epsilon*log(exp(1/params->epsilon*(params->Mmax/params->foi_slope-H))+1)+1.-params->Mmax)*I*params->beta;
}
